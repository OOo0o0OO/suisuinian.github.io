export default class Mottos {
    ...
    get cyclicMottos() {
        const { customMottoEnable, usingDefaultMottos, defaultMottos, customMottos } = this;
        let mottos = [];
    ...
    setCustomMottoEnable(value) {
        this.customMottoEnable = value;
        this.render(true);
    }
    setUsingDefaultMottos(value) {
        this.usingDefaultMottos = value;
        this.render(true);
    }
    setCustomMottos(value) {
        this.customMottos = value.split('+');
        this.render(true);
    }
    setMottoSwitchFrequency(value) {
        this.mottoSwitchFrequency = value * 1000;
    }
    setMottoSwitchOrder(value) {
        console.log(value);
